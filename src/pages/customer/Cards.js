...
const Cards = () => {
 ...
 const options = [
   { value: "", label: "Select a Pharmacy", img: "", message: "" },
   { value: "available", label: "Available pharm, 123 ave, Pittsburgh, PA, 11111", img: "./greenCheck.png", message: "Prescription is in stock at selected location"},
   { value: "lowStock", label: "Low Stock pharm, 456 dr, Pittsburgh, PA, 22222", img: "./warning.png", message: "Prescription is running low at selected location, it could take up to 2-3 days to refill your prescription."},
   { value: "unavailable", label: "Out of Stock pharm, 789 ln, Pittsburgh, PA, 33333", img: "./error.png", message: "Prescription is out of stock at selected location, it will take up to 3 days to refill your prescription."}
 ];

  const PharmComponent = () => (
                      ...
                      <div className='popup-container'>
                        <div className='pharmacy-info'>
                          <h3 className="pharm-header"> Select Pharmacy to Pick Up Prescription From: < /h3>
                            <Select className="pharm-dropdown"
                          ...
                          <div className="available">
                            ...
                            <img className='green-img' src={options.img} alt='' />
                            <p1 className="available-loc"> {options.message} < /p1>
                        ...
                        <div className="button-spacing">
                          <button12 onClick= { () => close() } > Cancel < /button12>
                        < /div>
                      < /div>
                    )
                  }
